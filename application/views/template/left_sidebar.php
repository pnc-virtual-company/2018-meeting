...
<aside class="app-sidebar">
  <ul class="app-menu" id="menu_leftsidebar">
    <li><a class="app-menu__item" href="#"><i class="app-menu__icon mdi mdi-map mdi-light mdi-24px"></i><span class="app-menu__label">Booking Room</span></a></li>
   ...
   <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon mdi mdi-home mdi-light mdi-24px"></i><span class="app-menu__label">Meeting Rooms</span><i class="treeview-indicator mdi mdi-arrow-right-drop-circle-outline"></i></a>
    ...
    <li><a class="app-menu__item" href="<?php echo base_url(); ?>welcome/select_room_request"><i class="app-menu__icon mdi mdi-library-books mdi-light mdi-24px"></i><span class="app-menu__label">My Reservation</span></a></li>
    ...
    <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon mdi mdi-home mdi-light mdi-24px"></i><span class="app-menu__label">Admin</span><i class="treeview-indicator mdi mdi-arrow-right-drop-circle-outline"></i></a>
     <ul class="treeview-menu" style="background-color: #026aab;">
          <li><a class="treeview-item" href="<?php echo base_url(); ?>welcome/occupancyRate"><i class="mdi mdi-checkbox-blank-circle  " style="font-size: 16px; color:black;"></i>&nbsp;Occupancy Rate</a></li>
          <li><a class="treeview-item" href="<?php echo base_url(); ?>welcome/listAllUsers"><i class="mdi mdi-checkbox-blank-circle " style="font-size: 16px; color:black;"></i>&nbsp;User Management</a></li>
          <li><a class="treeview-item" href="<?php echo base_url(); ?>welcome/location"><i class="mdi mdi-checkbox-blank-circle " style="font-size: 16px; color:black;"></i>&nbsp;Location Management</a></li>
    </ul>
   </li>
