...
<!-- Navbar-->
<header class="app-header"><a class="app-header__logo" href="<?php echo base_url(); ?>/welcome/location"><img src="<?php echo base_url(); ?>assets/images/logo_menu.png" alt="" style="max-width:100%; height:auto;"></a>
...
"><i class="mdi mdi-light mdi-settings mdi-24px  "></i></a>
      <ul class="dropdown-menu settings-menu dropdown-menu-right">
        <li><a class="dropdown-item" href="<?php echo base_url(); ?>welcome/user_profile"><i class="mdi mdi-account mdi-24px"></i> Profile</a></li>
