			...
			<form action="<?php echo base_url(); ?>welcome/update_request" method="post">
				<div class="form-group">
					...
					<div class="input-group date" id="datetimepicker1" data-target-input="nearest">
                    	<input type="text" value="<?php echo $rows->startDate; ?>" class="form-control datetimepicker-input" name="startDate" data-target="#datetimepicker1"/>
				...
				<div class="form-group">
					...
					<div class="input-group date" id="datetimepicker2" data-target-input="nearest">
                    	<input type="text" value="<?php echo $rows->endDate; ?>" name="endDate" class="form-control datetimepicker-input" data-target="#datetimepicker2"/>
