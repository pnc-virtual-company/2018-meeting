...
<div class="container">
    <div class="row">
      ...
      <div class="col-md-7">
        ...
        <hr>
        <a href="<?php echo base_url();?>" class="btn btn-primary" style="margin-left: 19px;"><i class="mdi mdi-backspace"></i>&nbsp;Back</a>
        <br><br>
    ...
    <div class="row">
      ...
      <div class="col-md-7">
        <div class="">
          ...
          <form method="POST" action="<?php echo base_url(); ?>Users/manualreset">
            <div class="card-body">
              <div class="form-group">
